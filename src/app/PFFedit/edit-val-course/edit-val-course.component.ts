...
@Component({
  selector: 'app-edit-val-course',
  templateUrl: './edit-val-course.component.html',
  styleUrls: ['./edit-val-course.component.scss']
})
export class EditValCourseComponent implements OnInit {

  editForm!:FormGroup;
  course:Course=new Course();
  constructor(private router:Router,private courseService:CourseService,private formBuilder:FormBuilder) { }
  ngOnInit(): void {
    let currentCourse = localStorage.getItem("editValCourseId");
    if(!currentCourse){
